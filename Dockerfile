...
RUN set -x \
    ...
    && curl -Ls                "https://www.atlassian.com/software/jira/downloads/binary/atlassian-jira-software-8.3.1.tar.gz" | tar -0xz --directory "${JIRA_INSTALL}" --strip-components=1 --no-same-owner \
